...
module.exports = {
    credentials: {
        ...
        azure: {
            ...
            // credential_file: '/path/to/file.json',
            // OPTION 2: If using hard-coded credentials, enter them below
            application_id: process.env.52ced015-3bb4-4ba6-978e-105192721322 || '',
            key_value: process.env.z8Q8Q~~rKxwVpzHDIbNGlNuwvf_wFXs~Px.J4bug || '',
             directory_id: process.env.2af1a359-046e-4283-baea-93da5ce16d76 || '',
             subscription_id: process.env.d8fac159-da11-4f27-97a1-265da3b6f06b || ''
        },
        azure_remediate: {
            // OPTION 1: If using a credential JSON file, enter the path below
            // credential_file: '/path/to/file.json',
